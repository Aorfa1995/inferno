...
<div class="container">
  ...
  <div class="col-md-2 mb-3">
   ...
   <div class="col-md-2 mb-3">
    ...
    <input type="text" class="form-control" id="" placeholder="Digite seu Celular" name="celular" value="<%out.print(request.getAttribute("celular"));%>">
  </div>
  ...
  <div class="form-row">
    ...
    <input type="email" class="form-control" id="" placeholder="Digite Email" name="senha" value="<%out.print(request.getAttribute("senha"));%>">
  </div>
